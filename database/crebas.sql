...
(
   ID_GAMBAR_EVENT      INT IDENTITY(1,1)                        NOT NULL,
   ID_MONTH_EVENT       INT                        not null,
...
(
   ID_GAMBAR_HOTEL      INT  IDENTITY(1,1)                       not null,
   ID_HOTEL             INT                        null,
...
(
   ID_GAMBAR_RUMAH_MAKAN INT  IDENTITY(1,1)                       not null,
   ID_RUMAH_MAKAN       INT                        null,
...
(
   ID_GAMBAR_WISATA     INT   IDENTITY(1,1)                      not null,
...
(
   ID_GAMBAR_TRANSPORTASI INT  IDENTITY(1,1)                       not null,
...
(
   ID_KATEGORI_RUMAH_MAKAN INT    IDENTITY(1,1)                     not null,
...
(
   ID_KATEGORI_TRANSPORTASI INT   IDENTITY(1,1)                      not null,
...
(
   ID_KATEGORI_WISATA   INT      IDENTITY(1,1)                   not null,
...
(
   ID_MAKANAN           INT   IDENTITY(1,1)                      not null,
...
(
   ID_MINUMAN           INT     IDENTITY(1,1)                    not null,
...
(
   ID_MONTH_EVENT       INT  IDENTITY(1,1)                       not null,
...
(
   ID_RUMAH_MAKAN       INT    IDENTITY(1,1)                     not null,
   ID_KATEGORI_RUMAH_MAKAN INT                        not null,
...
(
   ID_TOP_WISATA        INT    IDENTITY(1,1)                     not null,
   ID_WISATA            INT                        null,
...
(
   ID_TRANSPORTASI      INT   IDENTITY(1,1)                      not null,
...
create table WISATA 
(
   ID_WISATA            INT    IDENTITY(1,1)                     not null,
   ID_TOP_WISATA        INT                        null,
